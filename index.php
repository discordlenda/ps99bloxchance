...
<div class="section" style="width:calc(100% - 20px);">
  ...
  <div id='gamesheader' class="row" style="justify-content:space-between;">
    <div style="display:flex;gap:20px;align-items:center;">
        ...
        <?php if ($session) : ?>
            <strong>Profit: <?php echo getAllProfit($session["user_id"]); ?></strong>
        <?php endif; ?>
    </div>
    <div style="display:flex;gap:20px;align-items:center;">
        <?php if ($session) : ?>
...
?>
<div class="matches-container" style="display: flex; flex-wrap: wrap; gap: 20px;">
    <?php foreach ($matches as $match) : ?>
        <div id='game<?php echo $match["game_id"]; ?>' class="publicmatch row" style="flex: 1 1 calc(45% - 20px); box-sizing: border-box; padding: 10px; border: 1px solid #ccc; border-radius: 8px; position: relative;">
            <div style="display:flex;flex-direction:column;gap:10px;align-items:center;">
                ...
                <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;width:100%;">
                    <div style="position: relative;">
                        ...
                        <?php else : ?>
                            <img src="<?php echo $match["starter_side"] == 1 ? "./img/gem.png" : "./img/dog.png"; ?>" alt="<?php echo $match["starter_side"] == 0 ? "Gem" : "Dog"; ?>" width="20px" height="20px" style="position: absolute; top: 0; right: 0; z-index: 1;" loading="lazy">
                            <strong>V/S</strong>
                        <?php endif; ?>
                    </div>
                </div>
                <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
                    ...
                    <?php endforeach; ?>
                    <?php if ($match["end_date"]) : ?>
                        <div class="coin <?php echo $match["winner_side"] == 0 ? "red" : "blue"; ?>" style="margin-right: 10px;">
                            <img src="<?php echo $match["winner_side"] == 0 ? "./img/dog.png" : "./img/gem.png"; ?>" width="32px" height="32px" loading="lazy">
                        </div>
                    <?php endif; ?>
                    <strong>V/S</strong>
                    <?php
            ...
            <div style="text-align:center;padding-right:10px;">
                <?php if ($match["end_date"]) : ?>
                    <div class="coin <?php echo $match["winner_side"] == 0 ? "red" : "blue"; ?>" style="margin-bottom: 10px;">
                        <div class='blue'>
...
?>
    <div id='game<?php echo $match["game_id"]; ?>' class="mymatch row hidden" style="justify-content:space-around; flex-wrap: wrap;">
        <div style="display:flex;flex-direction:column;gap:10px;align-items:center;width:calc(100% - 100px);">
            <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:space-between;width:100%;">
                <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap; position: relative;">
                    <img src="<?php echo $match["starter_side"] == 0 ? "./img/gem.png" : "./img/dog.png"; ?>" 
                         alt="<?php echo $match["starter_side"] == 0 ? "Gem" : "Dog"; ?>" 
                    ...
                    foreach (json_decode($match["starter_items"], true) as $item) :
                    ?>
                        <img src="<?php echo getItemInfo($item["item_id"])["item_image"]; ?>" 
            ...
            <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:space-between;width:100%;">
                <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap; position: relative;">
                    <img src="<?php echo $match["starter_side"] == 1 ? "./img/gem.png" : "./img/dog.png"; ?>" 
                         alt="<?php echo $match["starter_side"] == 1 ? "Gem" : "Dog"; ?>" 
                         width="20px" height="20px" 
                         style="position: absolute; top: 0; right: 0; z-index: 1;" 
                         loading="lazy">
                    <?php if ($match["end_date"]) : ?>
